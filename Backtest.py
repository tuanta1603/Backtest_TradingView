...
# Until this value.
TO_DATE = '2024-05-01 09:00' # 테스트 기간의 마지막 기간

# First starting seed money
SEED_MONEY = 1000 # USDT
...
def Backtest(ticker):
    ...
    balance = SEED_MONEY
    winrate = 0
    print("1111111111111111111111111111", ticker)
    ...
    output_df['Date'] = date
    output_df['Order Price'] = price
    output_df['Order Size'] = size
    output_df['Profit or Loss'] = profitAmount
